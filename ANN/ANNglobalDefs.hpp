	...
	#define ANN_ALGORITHM_GIA_NEURAL_NETWORK	//optional?
		...
		#define ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS
			...
			//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX
				#define ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_COMPONENT_ORDER_PRINT_COLOURS
					...
					//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX_EXACT
						#define ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_COMPONENT_ORDER_PRINT_COLOURS_EXACT	//prints component connection colour depending on component index
						#ifndef ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_COMPONENT_ORDER_PRINT_COLOURS_EXACT
							#define ANN_ALGORITHM_SEQUENCE_GRAMMAR_NETWORK_COMPONENT_ORDER_PRINT_COLOURS_MAX_NUM_COMPONENTS (5)	//must sync with GIA_POS_REL_TRANSLATOR_SANI_SEQUENCE_GRAMMAR_TYPICAL_MAX_NUM_COMPONENTS
						#endif
					//#endif
				#endif
			//#endif
