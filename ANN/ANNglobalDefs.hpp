	...
	#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR	//optional?
		...
		#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS
			...
			//#endif
				...
				#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_LAST_GENERATED_SENTENCE_COLOR (SHARED_COLOUR_ORANGE)
				#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE_LEVEL_INACTIVE_COLOR (SHARED_COLOUR_BLUE)
			#endif
			...
			#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_WEIGHTS_PRINT_COLOURS	//default state (will be overwritten)
				...
				//#ifdef GIA_POS_REL_TRANSLATOR_SANI_ANN_COLOUR_CONNECTIONS_BASED_ON_COMPONENT_INDEX_EXACT
					#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_COMPONENT_ORDER_EXACT	//prints component connection colour depending on component index
						...
						//#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_COMPONENT_ORDER_EXACT_FIRST_COLOR (SHARED_COLOUR_MAGENTA)	//SHARED_COLOUR_PURPLE; 
						...
						//#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_COMPONENT_ORDER_EXACT_LAST_COLOR (SHARED_COLOUR_DARKBLUE)
				...
				#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE_LEVEL_INACTIVE_COLOR (SHARED_COLOUR_BLUE)
				#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE_LEVEL_PARTIAL_COLOR (SHARED_COLOUR_ORANGE)
				#define ANN_ALGORITHM_SANI_SEQUENCE_GRAMMAR_NETWORK_PRINT_COLOURS_ACTIVE_LEVEL_FULL_COLOR (SHARED_COLOUR_YELLOW)
			#endif
		#endif
	#endif
#endif
