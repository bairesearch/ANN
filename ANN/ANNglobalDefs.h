...
#define ANN_ALGORITHM_SEPARATE_CLASSIFICATION_AND_MEMORY_NETWORKS	//ANN 4a1a
	...
	#define ANN_ALGORITHM_SEPARATE_CLASSIFICATION_AND_MEMORY_NETWORKS_OUTPUT_NEURON_FIRE_TRESHOLD_FOR_CLASSIFICATION_BIT (0.9)	//tweak this
	...
	#define ANN_ALGORITHM_BACKPROPAGATION	//added ANN 4a2a - executes backpropogation algorithm before creating memory trace
#endif
